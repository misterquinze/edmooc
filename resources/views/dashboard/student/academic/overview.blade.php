...
{{-- @foreach ($courses as $course) --}}
    <li class="active"><a href="{{ URL('classroom/'.$ac_course->id.'/overview' ) }}"><i class="fa fa-book"></i> <span>Ringkasan</span></a></li>
            ...
            <template>
                <div id="display-container">
                    <div class="course-title">
                        <h2 class="course-name">{{$ac_course->name}}</h2>  
                    </div> 
                    <hr> 
                    ...
                    <div class="course-content">    
                        <div class="gridspan">
                            ...
                            <div class="middle-section">
                                ...
                                <div class="course-detail-value">{{ $ac_course->description }}</div>

                                <div class="course-detail-title">Tipe</div>
                                <div class="course-detail-value">{{ $ac_course->type }}</div>

                                <div class="course-detail-title">Price</div>
                                <div class="course-detail-value">Rp {{ number_format($ac_course->price) }}</div>

                            </div>

                            <div class="right-section">
                                <div class="course-detail-title">Institusi</div>
                                <div class="course-detail-value">{{ $ac_course->company->name }}</div>

                                <div class="course-detail-title">Mulai Kursus</div>
                                <div class="course-detail-value">{{ $ac_course->start_date }}</div>

                                <div class="course-detail-title">Kursus Berakhir</div>
                                <div class="course-detail-value">{{ $ac_course->end_date }}</div>
