        ...
        <div class="topic-content">
            ...
            <div class="topic-video">
                <video width="100%" controls>
                    <source src="{{$cont->source}}" type="video/mp4">
                    Tes
                </video>
                {{--<iframe class="topic-video" src="{{$cont->source}}" type="video/mp4" frameborder="1" allow="accelerometer; autoplay encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>--}}
            </div>
