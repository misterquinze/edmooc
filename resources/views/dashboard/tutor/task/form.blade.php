        ...
        <div id="forum">
            <template>
                <div id="form-container" class="form-create">
                    ...
                    <form action="{{route('content.store', [$courses->name])}}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="form-input">
                            ...
                            <div class="input-container">
                                ...
                                <div class="input-option gridspan">
                                    <span class="bullet"></span>
                                    <input type="text" class="input-answer-option" value="" autocomplete="off" placeholder="Opsi 2" required>
                                </div>
                                <div class="input-option gridspan">
                                    <span class="bullet"></span>
                                    <input type="text" class="input-answer-option" value="" autocomplete="off" placeholder="Opsi 3" required>
                                </div>
                                <div class="input-option gridspan">
                                    <span class="bullet"></span>
                                    <input type="text" class="input-answer-option" value="" autocomplete="off" placeholder="Opsi 4" required>
                                </div>
                                <div class="input-option gridspan">
                                    <span class="bullet"></span>
                                    <input type="text" class="input-answer-option" value="" autocomplete="off" placeholder="Opsi 5" required>
                                </div>
