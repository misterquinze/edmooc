            ...
            <template>
                <div id="display-container">
                    ...
                    <div class="course-content">    
                        <div class="gridspan">
                            ...
                            <div class="right-section">
                                ...
                                <div class="course-detail-value">{{ $accourse->company->name }}</div>

                                <div class="course-detail-title">Mulai Kursus</div>
                                <div class="course-detail-value">{{ $accourse->start_date }}</div>

                                <div class="course-detail-title">Kursus Berakhir</div>
                                <div class="course-detail-value">{{ $accourse->end_date }}</div>
                    ...
                    <div class="topic-content">
                        ...
                        @foreach($ac_topics as $topic)
                            ...
                            <form class="form-delete" id="delete-{{ $topic->id }}" action="{{route('tutor.actopic.delete', [$topic->id])}}  "  method="POST" style="display: none;">
                                {{ csrf_field() }}
                ...
                @foreach($ac_topics as $topic)
                    <div id="form-edit-{{ $topic->id }}" class="form-create form-edit">
                        ...
                        <form action="{{route('tutor.actopic.update', [$topic->id])}} " method="POST">
                            {{ csrf_field() }}
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="attachment-body-content">
                                <form id="form-container" class="form-horizontal" method="POST" action="">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="_method" value="put">
                                    <div class="card-body">
                                    <!-- name -->
                ...
                <div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="add-modal-label" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="attachment-body-content">
                                <form id="form-container" class="form-horizontal" method="POST" action="{{ route('tutor.actopic.create', [$accourse->id]) }}">
                                    {{ csrf_field() }}
                                    <div class="card-body">
                                    <!-- name -->
                                        <div class="input-container">
